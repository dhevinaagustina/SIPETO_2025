    ...
    <section id="contact" class="contact section">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-7">
            <form action="{{ url('/send-contact') }}" method="POST" class="php-email-form" data-aos="fade-up" data-aos-delay="200">
              @csrf
              <div class="row gy-4">
      ...
      <div class="container">
        <div class="row justify-content-center text-center">
          <div class="col-lg-6">
            ...
            <form action="{{ url('/subscribe-newsletter') }}" method="POST" class="php-email-form">
              @csrf
